...
class SpeedControllerTestCase(unittest.TestCase):
    def test_getMaxSpeed(self):
        ...
        speed = controller.getMaxSpeed(position=(10, 0), width=1)
        self.assertEqual(speed, 5, 'invalid default max speed')
        speed = controller.getMaxSpeed(position=(42, 1), width=1)
        self.assertEqual(speed, 5, 'invalid default max speed')
        # Custom max speed.
        ...
        speed = controller.getMaxSpeed(position=(9, 0), width=1)
        self.assertEqual(speed, 10, 'invalid limit')
        speed = controller.getMaxSpeed(position=(21, 0), width=1)
        self.assertEqual(speed, 10, 'invalid limit')
        speed = controller.getMaxSpeed(position=(10, 0), width=1)
        self.assertEqual(speed, 5, 'invalid limit')
        speed = controller.getMaxSpeed(position=(15, 0), width=1)
        self.assertEqual(speed, 5, 'invalid limit')
        speed = controller.getMaxSpeed(position=(20, 0), width=1)
        self.assertEqual(speed, 5, 'invalid limit')
        ...
        speed = controller.getMaxSpeed(position=(9, 0), width=1)
        self.assertEqual(speed, 10, 'invalid limit')
        speed = controller.getMaxSpeed(position=(26, 0), width=1)
        self.assertEqual(speed, 10, 'invalid limit')
        speed = controller.getMaxSpeed(position=(10, 0), width=1)
        self.assertEqual(speed, 5, 'invalid limit')
        speed = controller.getMaxSpeed(position=(14, 0), width=1)
        self.assertEqual(speed, 5, 'invalid limit')
        speed = controller.getMaxSpeed(position=(15, 0), width=1)
        self.assertEqual(speed, 3, 'invalid limit')
        speed = controller.getMaxSpeed(position=(25, 0), width=1)
        self.assertEqual(speed, 3, 'invalid limit')
